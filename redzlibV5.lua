	...
	Themes = {
		...
		Darker = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(5, 0, 50))
			}),
		...
		Dark = {
			...
			["Color Stroke"] = Color3.fromRGB(26, 26, 26),
		...
		while true do
			...
			pcall(function()
				...
				if floatBtn then
					...
					if fStroke then
						local sVal = (math.sin(t * 2.0) + 1) / 2
						fStroke.Color = Color3.fromRGB(0, 215, 255):Lerp(Color3.fromRGB(180, 240, 255), sVal)
					end
				end
			end)
		end
