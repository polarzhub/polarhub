...
local getgenv().PolarSelectedBossToFarm = "Gorilla King"
getgenv().Polargetgenv().PolarAutoFarmBossEnabled = false
getgenv().Polargetgenv().PolarAutoFarmAllBossesEnabled = false
getgenv().Polargetgenv().PolarBossWithQuest = false
...
getgenv().Polargetgenv().PolarCurrentBotState = "IDLE"
...
getgenv().Polargetgenv().PolarFastAttackEnabled = false
